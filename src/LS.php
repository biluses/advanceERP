...
class LS {
  ...
  public static $default_config = array(
     ...
     */
    "basic" => array(
      "company" => "Advance Mobile Advertising",
      "email" => "sergio.suarez@advancemobile.net",
    ...
    "db" => array(
       ...
       * MySQL options
       */
      "host" => "b672472483.db.1and1.com",
      "port" => "3306",

      /**
       * SQLite options
       */
      "sqlite_path" => "/home/simsu/mydb.sqlite",
      ...
      if($state === "invalidToken")
        ...
        return "<form action='". self::curPageURL() ."' method='POST'>
          <label>
            ...
            <input class='border-radius-top' type='text' id='logSysIdentification' placeholder='Enter your {$extraInfo["identity_type"]}' style='width: 100%' name='identification' />
          </label>
          <p><button class='button small border-radius-bottom coral-bg' name='logSysForgotPass' type='submit' style='width: 100%'>Reset Password</button></p>
        </form>
